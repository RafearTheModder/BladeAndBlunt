...
namespace Hooks
{
	...
	inline static REL::Relocation<std::uintptr_t> Block_GameSetting_Hook{ REL::RelocationID(42842,44014), REL::Relocate(REL::Module::IsVR() ? 0x650 : 0x452,0x438) }; // Match in library, but offset should be 0x650 instead for VR
